<template>
  <div class="layout-padding">
    ...
    <q-select class="q-ma-md" outlined @input="setToolbar" label="Toolbar project" v-model="project" :options="projectOptions" map-options emit-value/>
    <q-select v-if="project" class="q-ma-md" v-model="icon" @input="setIcon" label="Project icon" outlined :options="iconOptions" map-options emit-value/>
...
export default {
  ...
  mounted () {
    ...
    this.$axios.get(process.env.API + '/myprojects/' + this.user.id)
      .then(response => {
